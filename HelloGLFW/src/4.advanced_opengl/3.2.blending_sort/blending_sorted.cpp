...
int main()
{
    ...
    Shader shader("src/4.advanced_opengl/5.framebuffers/framebuffers.vs", "src/4.advanced_opengl/5.framebuffers/framebuffers.frag");
    Shader screenShader("src/4.advanced_opengl/5.framebuffers/framebuffers_screen.vs", "src/4.advanced_opengl/5.framebuffers/framebuffers_screen.frag");
