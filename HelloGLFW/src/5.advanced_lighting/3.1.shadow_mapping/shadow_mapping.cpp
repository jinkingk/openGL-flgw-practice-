...
int main()
{
	...
	std::string path = "src/5.advanced_lighting/3.1.shadow_mapping/";
	std::string tmp = "";
    Shader shader("src/5.advanced_lighting/3.1.shadow_mapping/shadow_mapping.vs", "src/5.advanced_lighting/3.1.shadow_mapping/shadow_mapping.frag");
    Shader simpleDepthShader("src/5.advanced_lighting/3.1.shadow_mapping/shadow_mapping_depth.vs", "src/5.advanced_lighting/3.1.shadow_mapping/shadow_mapping_depth.frag", "src/5.advanced_lighting/3.1.shadow_mapping/shadow_mapping_depth.gs");
    Shader debugDepthQuad("src/5.advanced_lighting/3.1.shadow_mapping/debug_quad.vs", "src/5.advanced_lighting/3.1.shadow_mapping/debug_quad_depth.frag");
