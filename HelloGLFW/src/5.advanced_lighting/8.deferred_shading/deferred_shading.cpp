...
int main()
{
	...
	Shader shaderGeometryPass("src/5.advanced_lighting/8.deferred_shading/g_buffer.vs", "src/5.advanced_lighting/8.deferred_shading/g_buffer.frag");
	Shader shaderLightingPass("src/5.advanced_lighting/8.deferred_shading/deferred_shading.vs", "src/5.advanced_lighting/8.deferred_shading/deferred_shading.frag");
	Shader shaderLightBox("src/5.advanced_lighting/8.deferred_shading/deferred_light_box.vs", "src/5.advanced_lighting/8.deferred_shading/deferred_light_box.frag");
