...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		lightingShader.Use();
		//GLint lightPosLoc = glGetUniformLocation(lightingShader.Program, "light.direction");
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "light.position"), camera.Position.x, camera.Position.y, camera.Position.z);
